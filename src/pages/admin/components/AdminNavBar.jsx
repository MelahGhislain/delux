...
const AdminNavBar = ({setSideNav}) => {
  ...
  return (
    <div className='flex px-8 py-6 border-b bg-white '>
    ...
    <div className='flex items-center flex-none space-x-8 '>
        {/* search */}
        <div className='flex items-center border rounded overflow-hidden divide-x bg-neutral-100 divide-gray-300 py-1 px-1'>
            <span className='px-4'>
