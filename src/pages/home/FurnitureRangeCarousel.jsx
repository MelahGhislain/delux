    ...
    return (
        <div className="container mx-auto">
            <div className="flex items-center justify-center w-full h-full py-4 sm:py-8 px-4">
                ...
                <CarouselProvider className="lg:block " naturalSlideWidth={100} isIntrinsicHeight={true} totalSlides={12} visibleSlides={4} step={1} infinite={true}>
                                    ...
                                    <Slide >
                                        <div className="flex flex-shrink-0 relative w-full sm:w-auto cursor-pointer duration-500 transition-all hover:scale-105">
                                            <a href="/products" className="group" >
                                                ...
                                                <h4 className="transition-all duration-300 group-hover:text-teal-600 text-xs md:text-sm mt-2 text-gray-600">Coffee Tables</h4>
                                            </a>
                                        </div>
                                    </Slide>
