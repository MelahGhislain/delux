    ...
    <div className=' '>
        <div className='bg-[#eff7fa] flex px-4 md:px-10 lg:px-24 py-10 flex-col md:flex-row'>
            ...
            <div className='md:w-[30rem]'>
                ...
                {/* adress */}
                <div className='mt-8'>
                    <div className='flex text-gray-600 font-normal space-x-3 items-center'>
                        <span>
                ...
                {/* follow */}
                <div className='mt-4'>
                    <div className='flex text-gray-500 font-normal space-x-3 items-center'>
                        <span>
                            Follow :
                        </span>
                        <div className='flex items-center space-x-2'>
                            <div className='border bg-white h-[1.5rem] w-[1.5rem] rounded-full flex items-center justify-center'>
